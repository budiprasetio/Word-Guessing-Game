...
//     }
//     clearInterval(timer);
//     alert(`Waktu habiss!!! ${userWord.toUpperCase()} jawaban kamu benar... :))`);
//     initGame();
//   }, 1000);
// };
...
//   }
//   wordText.innerText = wordArray.join(""); //meneruskan kata yang diacak sebagai teks kata
//   hintText.innerText = randomObj.hint; //buat passing random object hint
...
//   if (!userWord) return alert("Please lah masukin kata katanya...");
